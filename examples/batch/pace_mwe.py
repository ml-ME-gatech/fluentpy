...
#package imports
from fluentpy.batch.submit import PaceBatchSubmission
...
#PACE @ GT easily
submission = PaceBatchSubmission.from_frame('ICM-11.cas.gz','ke-standard',parameter_table,pbs)
...
submission.generate_submission('test-case')
